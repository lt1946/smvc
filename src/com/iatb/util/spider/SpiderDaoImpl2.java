...
public class SpiderDaoImpl2 {
	private static final Logger log=Logger.getLogger(SpiderDaoImpl2.class);
	private Connection conn = ConnTools.makeConnection("spider2011");
	public SpiderDaoImpl2() {
		super();
	}
	...
	public static SpiderDaoImpl2 instance(){
		return new SpiderDaoImpl2();
	}
...
//			System.exit(1);
	...
	public static void main(String[] args) {
		SpiderDaoImpl2 sdi=new SpiderDaoImpl2();
