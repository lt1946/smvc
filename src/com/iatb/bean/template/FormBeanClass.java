...
public class FormBeanClass {
	...
	public String getContent() {
		return IOUtil.readFileToString(PropUtil.getConfProp("template").getProperty("formbeanFile"),p.getProperty("encode"));
	}
	
	public FormBeanClass(String tableName) {
	...
	public String getClassPackage() {
		return p.getProperty("formBeanPackage");
	}
...
//			System.out.println(k+":"+cb.getColumnTypeName()); 
			if(b){s="int";}else if(bb){s="String";}else if(bbb){s="Double";}else{s="boolean";}
			if(name.equals("createTime")||name.equals("status")){
			}else{
				sb.append(s+" "+name+",");
			}
		}
